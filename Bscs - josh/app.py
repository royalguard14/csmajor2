...
def load_dataframe(d,c,bi,bus,tr,time):
    csv_path = 'TrafficCSMAJ-josh.csv'  # Change this to your file's path
...
def search():
    ...
    time_string = float(request.form.get('time'))


    data_to_predict = load_dataframe(date_value,car_value,bike_value,bus_value,truck_value,time_string)
