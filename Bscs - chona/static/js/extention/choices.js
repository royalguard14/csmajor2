	...
	var Choices = function () {
	  function Choices() {
	    ...
	    $.ajax({
	    	...
	    	type: 'GET',
	    	data: {
	    		'search': (0, _utils.stripHTML)(value)
	    	},
	    	dataType: 'json',
	    	...
	    	/*	console.log(dataList.innerHTML)
	    		document.getElementById("p1").innerHTML = data['results'][0]["item"];*/
	    		for (var i = 0; i < data['results'].length; i++) {
	    			$('#suggestions').append("<option>" + data['results'][i]["item"] + "</option>");
	    		}


        // Apply styles for scrollable list
        dataList.size = data['results'].length > 5 ? 5 : data['results'].length;
